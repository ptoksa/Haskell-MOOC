...
countdown x = countdownhelper x "Ready!"
countdownhelper :: Integer -> String -> String
countdownhelper x s
    | x == 0 = s ++ " Liftoff!"
    | otherwise = countdownhelper (x-1) (s ++ " " ++ show x ++ "...")
------------------------------------------------------------------------------
...
smallestDivisor x = smalldivisorfinder x 2 
smalldivisorfinder :: Integer -> Integer -> Integer
smalldivisorfinder x divisor
    | divisor == x = x
    | mod x divisor == 0 = divisor
    | otherwise = smalldivisorfinder x (divisor+1)
------------------------------------------------------------------------------
