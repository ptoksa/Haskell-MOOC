...
count elem = foldr (\curr acc -> if curr == elem then acc + 1 else acc) 0
------------------------------------------------------------------------------
...
inBoth x y = foldr (\curr acc -> if curr `elem` y then curr : acc else acc) [] x
------------------------------------------------------------------------------
...
instance Foldable List where
  ...
  foldr f init (LNode x y) = f x (foldr f init y)
------------------------------------------------------------------------------
...
instance Foldable TwoList where
  ...
  foldr f init (TwoNode a b y) = f a (f b (foldr f init y))
------------------------------------------------------------------------------
